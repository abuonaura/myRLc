    ...
    for tt in types:
        ...
        for cut in cuts:
            ...
            for polarity in polarities:
                f = r.TFile(filedir + 'Lb_Data_'+polarity+'_preselected_'+tt+'_sw.root')
                t = f.Get('DecayTree')
                df0 = r.RDataFrame(t)
            ...
            if n==1:
                ...
                c.SaveAs('plots/muProbNNvsMuGhost_'+tt+'.png')
            ...
            c2.SaveAs('plots/FitVars_'+tt+'_ProbNNghost_'+str(cut)+'.png')
