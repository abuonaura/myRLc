...
def AddSweights(ifile,polarity,particle,sample):
    ...
    of_fit = r.TFile(datadir+'MISID/IntermediateFiles_OS/FitResults/FitResults_'+particle+'_'+polarity+ suffix[sample],'Recreate')
    result.Write()
    of_fit.Close()
...
if __name__ == '__main__':
    ...
    files = {'MagUp': datadir+'Data/Lb_FakeMu_MagUp_preselected'+suffix[sample][0:-5]+'_sw.root',
        'MagDown': datadir+'Data/Lb_FakeMu_MagDown_preselected'+suffix[sample][0:-5]+'_sw.root'}
