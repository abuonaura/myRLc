...
def GetFileList(category,MCtype):
    ...
    if category=='Kenriched':
        ...
        if MCtype=='MCTrackerOnly':
            ...
            'MISID':['MISID/OppositeSign/K_sample_MagUp_Kenr_sw_withCF.root','MISID/OppositeSign/K_sample_MagDown_Kenr_sw_withCF.root','MISID/OppositeSign/Pi_sample_MagUp_Kenr_sw_withCF.root','MISID/OppositeSign/Pi_sample_MagDown_Kenr_sw_withCF.root'],
            'Combinatorial': ['CombinatorialBkg/CombinatorialBkg_MagUp_Kenr.root','CombinatorialBkg/CombinatorialBkg_MagDown_Kenr.root'],
            'mu':['MC_TrackerOnly/Lb_Lcmunu_MagUp_preselected_Kenr.root','MC_TrackerOnly/Lb_Lcmunu_MagDown_preselected_Kenr.root'],
            'tau':['MC_TrackerOnly/Lb_Lctaunu_MagUp_preselected_Kenr.root','MC_TrackerOnly/Lb_Lctaunu_MagDown_preselected_Kenr.root'],
            '2charm':['MC_TrackerOnly/Lb_LcDs_MagUp_preselected_Kenr.root','MC_TrackerOnly/Lb_LcDs_MagDown_preselected_Kenr.root'],
            'starmu':['MC_TrackerOnly/Lb_Lc2625munu_MagUp_preselected_Kenr.root','MC_TrackerOnly/Lb_Lc2593munu_MagUp_preselected_Kenr.root','MC_TrackerOnly/Lb_Lc2625munu_MagDown_preselected_Kenr.root','MC_TrackerOnly/Lb_Lc2593munu_MagDown_preselected_Kenr.root'],
            'starDs':['MC_TrackerOnly/Lb_Lc2625Ds_MagUp_preselected_Kenr.root','MC_TrackerOnly/Lb_Lc2593Ds_MagUp_preselected_Kenr.root','MC_TrackerOnly/Lb_Lc2625Ds_MagDown_preselected_Kenr.root','MC_TrackerOnly/Lb_Lc2593Ds_MagDown_preselected_Kenr.root'],
            'startau':['MC_TrackerOnly/Lb_Lc2625taunu_MagUp_preselected_Kenr.root','MC_TrackerOnly/Lb_Lc2593taunu_MagUp_preselected_Kenr.root','MC_TrackerOnly/Lb_Lc2625taunu_MagDown_preselected_Kenr.root','MC_TrackerOnly/Lb_Lc2593taunu_MagDown_preselected_Kenr.root']
            }
    if category=='Lcpipi':
        if MCtype=='MCfull':
            ...
            'mu':['MC_full_new/Lb_Lcmunu_MagUp_full_preselected_Lcpipi.root','MC_full_new/Lb_Lcmunu_MagDown_full_preselected_Lcpipi.root'],
            'tau':['MC_full_new/Lb_Lctaunu_MagUp_full_preselected_Lcpipi.root','MC_full_new/Lb_Lctaunu_MagDown_full_preselected_Lcpipi.root'],
            '2charm':['MC_full_new/Lb_LcDs_MagUp_full_preselected_Lcpipi.root','MC_full_new/Lb_LcDs_MagDown_full_preselected_Lcpipi.root'],
            'starmu':['MC_full_new/Lb_Lc2625munu_MagUp_full_preselected_Lcpipi.root','MC_full_new/Lb_Lc2593munu_MagUp_full_preselected_Lcpipi.root','MC_full_new/Lb_Lc2625munu_MagDown_full_preselected_Lcpipi.root','MC_full_new/Lb_Lc2593munu_MagDown_full_preselected_Lcpipi.root'],
            'starDs':['MC_full_new/Lb_Lc2625Ds_MagUp_full_preselected_Lcpipi.root','MC_full_new/Lb_Lc2593Ds_MagUp_full_preselected_Lcpipi.root','MC_full_new/Lb_Lc2625Ds_MagDown_full_preselected_Lcpipi.root','MC_full_new/Lb_Lc2593Ds_MagDown_full_preselected_Lcpipi.root'],
            'startau':['MC_full_new/Lb_Lc2625taunu_MagUp_full_preselected_Lcpipi.root','MC_full_new/Lb_Lc2593taunu_MagUp_full_preselected_Lcpipi.root','MC_full_new/Lb_Lc2625taunu_MagDown_full_preselected_Lcpipi.root','MC_full_new/Lb_Lc2593taunu_MagDown_full_preselected_Lcpipi.root']
            }
...
if __name__== "__main__":
    ...
    outfile_name = 'RootFiles/Histos_'+category+'_'+MCtype+'_noLbCorr.root'
