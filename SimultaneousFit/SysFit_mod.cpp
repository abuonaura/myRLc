...
SysFit::SysFit()
{
	...
	start_parameters["Isolated"].insert(pair<string, vector<Double_t>>("Ncstar2593mu_Isolated",{2.6E5,3.E4,1.E6}));
	start_parameters["Isolated"].insert(pair<string, vector<Double_t>>("Ncstar2625mu_Isolated",{2.6E5,3.E4,1.E6}));
...
{
	TString name = "";
	if (component.Contains("_Lcmunu_")) name = "#Lambda_{b} #rightarrow #Lambda_{c} #mu #nu";
	else if(component.Contains("h_Lc2625munu_")) name = "#Lambda_{b} #rightarrow #Lambda_{c}*(2625) #mu #nu_{#mu}";
	else if(component.Contains("h_Lc2593munu_")) name = "#Lambda_{b} #rightarrow #Lambda_{c}*(2593) #mu #nu_{#mu}";
	...
	else if(component.Contains("_Lctaunu_")) name = "#Lambda_{b} #rightarrow #Lambda_{c} #tau #nu_{#tau}";
	else if(component.Contains("h_LcDs-2body")) name = "#Lambda_{b} #rightarrow #Lambda_{c} X_{c}";
	else if(component.Contains("h_LcDs-mbody")) name = "#Lambda_{b} #rightarrow #Lambda_{c} X_{c} X";
...
{       
	Int_t color=-99;
	if (component.Contains("_Lcmunu_")) color = kBlue;
	else if(component.Contains("h_mu_")) color = kViolet;
	...
	else if(component.Contains("_Lctaunu_"))color = kRed;
