...
parser.add_argument('--HLT1',dest='restartHLT1', help="Forces to reproduce a file with both HLT1 emulations", required=False, default=False, action='store_true')
...
restartHLT1 = options.restartHLT1
