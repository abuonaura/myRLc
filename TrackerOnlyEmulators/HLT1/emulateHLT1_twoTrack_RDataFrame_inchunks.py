...
if __name__ == "__main__":
    ...
    MC_fileName = options.file
    start = int(options.start)
    stop = int(options.stop)
    nfile = int(options.nfile)

    F=r.TFile(MC_fileName)
    T=F.Get("tupleout/DecayTree")

    df = r.RDataFrame(T)
    if(stop<T.GetEntries()):
        df0 = df.Range(start,stop)
    elif (start<T.GetEntries() and stop>T.GetEntries()):
        df0 = df.Range(start,T.GetEntries())
    elif (start>T.GetEntries() and stop>T.GetEntries()):
        sys.exit()
    ...
    fname = MC_fileName[:-5]+"_wHLT1TwoTracksEmulation_"+str(nfile)+".root"
    df2.Snapshot("DecayTree",fname,"Lc_HLT1TwoTrackMVA_Emu_EffCorr_TOS")
    print("Processed "+str(stop)+" entries")
...
bool emulateHLT1TwoTrackMVA(bool isGECPassed, bool isTrackPassed_K, bool isTrackPassed_p, bool isTrackPassed_pi, 
                            bool isTrackReco_p, bool isTrackReco_K, bool isTrackReco_pi, bool trackRecoCorrection,
                            double Lb_VERTEX_CHI2_COMB_1_2, double Lb_VERTEX_CHI2_COMB_1_3, double Lb_VERTEX_CHI2_COMB_2_3,
                            double Lb_ETA_COMB_1_2, double Lb_ETA_COMB_1_3, double Lb_ETA_COMB_2_3,
                            double Lb_MCORR_OWNPV_COMB_1_2, double Lb_MCORR_OWNPV_COMB_1_3, double Lb_MCORR_OWNPV_COMB_2_3,
                            double Lb_DIRA_OWNPV_COMB_1_2, double Lb_DIRA_OWNPV_COMB_1_3, double Lb_DIRA_OWNPV_COMB_2_3,
                            double Lb_DOCA_COMB_1_2, double Lb_DOCA_COMB_1_3, double Lb_DOCA_COMB_2_3,
                            double Lb_VDCHI2_OWNPV_COMB_1_2, double Lb_VDCHI2_OWNPV_COMB_1_3, double Lb_VDCHI2_OWNPV_COMB_2_3,
                            double Lb_IPCHI2_OWNPV_COMB_1_2,double Lb_IPCHI2_OWNPV_COMB_1_3, double Lb_IPCHI2_OWNPV_COMB_2_3,
                            double Lb_HLt1TwoTrackMVAEmulations_1_2,double Lb_HLt1TwoTrackMVAEmulations_1_3, 
                            double Lb_HLt1TwoTrackMVAEmulations_2_3,
                            double p_PX, double p_PY, double p_P, double p_PT, 
                            double pi_PX, double pi_PY, double pi_P, double pi_PT, 
                            double K_PX, double K_PY, double K_P, double K_PT)
{
    //p=1, K=2, pi=3    
    if(isGECPassed==false) return false;
    ...
    bool HLT1_2TrackComb_1_2 = HLT1TwoTrackMVADecision(Lb_VERTEX_CHI2_COMB_1_2, Lb_ETA_COMB_1_2, Lb_MCORR_OWNPV_COMB_1_2, Lb_DIRA_OWNPV_COMB_1_2, Lb_HLt1TwoTrackMVAEmulations_1_2, SUMPT_1_2, Lb_DOCA_COMB_1_2, Lb_VDCHI2_OWNPV_COMB_1_2);
    bool HLT1_2TrackComb_1_3 = HLT1TwoTrackMVADecision(Lb_VERTEX_CHI2_COMB_1_3, Lb_ETA_COMB_1_3, Lb_MCORR_OWNPV_COMB_1_3, Lb_DIRA_OWNPV_COMB_1_3, Lb_HLt1TwoTrackMVAEmulations_1_3, SUMPT_1_3, Lb_DOCA_COMB_1_3, Lb_VDCHI2_OWNPV_COMB_1_3);
    bool HLT1_2TrackComb_2_3 = HLT1TwoTrackMVADecision(Lb_VERTEX_CHI2_COMB_2_3, Lb_ETA_COMB_2_3, Lb_MCORR_OWNPV_COMB_2_3, Lb_DIRA_OWNPV_COMB_2_3, Lb_HLt1TwoTrackMVAEmulations_2_3, SUMPT_2_3, Lb_DOCA_COMB_2_3, Lb_VDCHI2_OWNPV_COMB_2_3);
