...
pathToOutput = '/disk/gangadir/buonaura/gangadir/workspace/buonaura/LocalXML/Datasets/HistoPID/MISIDeff_Ghost/'
...
muid = 'IsMuon==1 && DLLmu>2.0 && DLLmu-DLLK>2.0 && DLLmu-DLLp>2.0 && DLLe<1 && MC15TuneV1_ProbNNghost < 0.2'
