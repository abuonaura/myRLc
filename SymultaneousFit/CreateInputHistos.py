...
def GetFileList(category):
    if category=='Isolated':
        startfiles={'data':['Data/Lb_Data_MagUp_reduced_preselected_iso_sw.root','Data/Lb_Data_MagDown_reduced_preselected_iso_sw.root'],
                    'MISID':['MISID/K_sample_MagDown_iso_sw_withCF.root','MISID/K_sample_MagUp_iso_sw_withCF.root','MISID/Pi_sample_MagDown_iso_sw_withCF.root','MISID/Pi_sample_MagUp_iso_sw_withCF.root'],
    ...
    if category=='Kenriched':
        startfiles ={'data':['ControlSamples/Lb_Data_MagUp_reduced_preselected_Kenr_sw.root','ControlSamples/Lb_Data_MagDown_reduced_preselected_Kenr_sw.root'],
            'MISID':['MISID/K_sample_MagUp_Kenr_sw_withCF.root','MISID/K_sample_MagDown_Kenr_sw_withCF.root','MISID/Pi_sample_MagUp_Kenr_sw_withCF.root','MISID/Pi_sample_MagDown_Kenr_sw_withCF.root'],
...
def FillHistograms(category):
    ...
    for sample in startfiles.keys():
        ...
        if sample=='2charm':
            ...
            h_2body = r.TH3F('h_'+sample+'_2body',"qem_"+sample,4,-2,14,10,0,2600,10,-2,14)
            h_mbody = r.TH3F('h_'+sample+'_mbody',"qem_"+sample,4,-2,14,10,0,2600,10,-2,14)
            h_mbody_1pl = r.TH3F('h_'+sample+'_mbody_1pl',"qem_"+sample,4,-2,14,10,0,2600,10,-2,14)
            h_mbody_1ml = r.TH3F('h_'+sample+'_mbody_1ml',"qem_"+sample,4,-2,14,10,0,2600,10,-2,14)
            h_mbody_1pq = r.TH3F('h_'+sample+'_mbody_1pq',"qem_"+sample,4,-2,14,10,0,2600,10,-2,14)
            h_mbody_1mq = r.TH3F('h_'+sample+'_mbody_1mq',"qem_"+sample,4,-2,14,10,0,2600,10,-2,14)
